...
export const T: Record<Lang, Dict> = {
  fr: {
    ...
    dateSubtitle: "Générateur d'idée d'activité originale pour que chaque jour soit rempli de découverte et de fun.",
    letsGo: "Let's go !",
    regenerate: "Regénérer les idées",
    chooseOne: "Mon challenge du jour",
  ...
  en: {
    ...
    dateSubtitle: "Original activity idea generator so every day is filled with discovery and fun.",
    letsGo: "Let's go!",
    regenerate: "Regenerate ideas",
    chooseOne: "My daily challenge",
  ...
  zh: {
    ...
    navReport: "报告",
    pickDate: "选择今天的日期",
    dateSubtitle: "原创活动创意生成器，让每一天都充满发现与乐趣。",
    letsGo: "开始！",
    regenerate: "重新生成建议",
    chooseOne: "我的每日挑战",
